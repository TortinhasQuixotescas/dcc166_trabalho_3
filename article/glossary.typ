#let glossary_entries = (
  ...
  prouni: (
    short: "ProUni",
    long: "Programa Universidade para Todos",
  ),
  enem: (
    short: "Enem",
    long: "Exame Nacional do Ensino Médio",
  ),
  ies: (
    short: "IES",
    plural: "IESs",
    long: "Instituição de Ensino Superior",
    longplural: "Instituições de Ensino Superior",
  ),
  pne: (
    short: "PNE",
    long: "Plano Nacional de Educação",
  ),
  ibge: (
    short: "IBGE",
