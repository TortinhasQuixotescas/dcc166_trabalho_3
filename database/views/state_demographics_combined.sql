DROP MATERIALIZED VIEW IF EXISTS public.state_demographics_combined CASCADE;
CREATE MATERIALIZED VIEW public.state_demographics_combined AS
WITH state_data AS (
    SELECT 
        cdc.uf,
...
CREATE INDEX idx_state_demographics_combined_uf ON public.state_demographics_combined(uf);
